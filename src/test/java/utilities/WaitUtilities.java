...
public class WaitUtilities {
	...
	public static void waitForElementInViewport(WebDriverWait wait, WebElement element) {
		...
		wait.until(
				d -> (Boolean) ((JavascriptExecutor) d).executeScript("var rect = arguments[0].getBoundingClientRect();"
	...
	public static WebElement presenceOfElementLocated(WebDriverWait wait,By Locator) {
		return  wait.until(ExpectedConditions.presenceOfElementLocated(Locator));
	}
}
